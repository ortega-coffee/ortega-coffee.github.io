...
image: "" 
    ...
    access: {
        ...
        note: "※店頭販売などの詳細はSNSをご覧ください。・お支払いは現金のみとさせていただいております。・1杯ずつお作りするため、ご提供までにお時間をいただきます。・専用駐車場はございません。近隣のコインパーキングをご利用ください。・閑静な住宅街のため、路上駐車や騒音等、周囲へのご配慮を心よりお願い申し上げます。",
