...
皆さまと心地よい時間を共有できるよう、ご理解とご協力をお願い申し上げます。`,
    ...
    menu: {
        ...
        items: [
            {
                category: "", 
                name: "準備中です。解禁まで、今しばらくお待ちください。※Instagramでは最新の状況を随時発信しております。お手数ですが、あわせてご確認いただけますと幸いです。",
                subName: "", 
                price: "",
                image: "" 
            },
    ...
    access: {
        ...
        businessHours: "平日（火-木）/ 12:00-19:00<br>金・土/ 13:00-21:00日/ 12:00-18:00※各日、閉店30分前l.o12:00 - 19:00（各日閉店30分前L.o.）",
